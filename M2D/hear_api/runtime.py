import sys
import os
sys.path.append(os.path.abspath("../../M2D/m2d"))
sys.path.append('..')
...
class RuntimeM2D(torch.nn.Module):
    def __init__(self, 
                 model_size,
                 **kwargs) -> None:
        super().__init__()
        self.model = PortableM2D("../m2d/m2d_vit_base-80x608p16x16-221006-mr7/checkpoint-300.pth")
    ...
    def get_timestamp_embeddings(self, audio):
        ...
        with torch.no_grad():
            scene_embeddings = self.model(batch_audio)
