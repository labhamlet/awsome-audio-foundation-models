...
cd ~/phd/awsome-audio-foundation-models/HuggingfaceModels/Whisper
module load 2023
module load Anaconda3/2023.07-2
source activate hear-other-models-eval
cd listen-eval-kit

embeddings_dir=/projects/0/prjs1338/WhisperEmbeddingsNatHear
score_dir=nathear_scores
task_name=${task_names[$SLURM_ARRAY_TASK_ID]}
task_dir=${task_dirs[$SLURM_ARRAY_TASK_ID]}

model_name=hear_configs.whisper
model_size=base
