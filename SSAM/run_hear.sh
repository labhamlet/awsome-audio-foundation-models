...
export PT_MAMBA_MODEL_DIR=~/phd/hear-other-models-niche/AudioMAMBA


cd ~/phd/hear-other-models-niche/AudioMAMBA
module load 2023
module load Anaconda3/2023.07-2
source activate audio-mamba-eval
cd listen-eval-kit
...
model_name=hear_configs.ssam_base_200_16x4
