...
cd ~/phd/awsome-audio-foundation-models/MSM-MAE
module load 2023
module load Anaconda3/2023.07-2
source activate msm-mae-eval
cd listen-eval-kit

embeddings_dir=/projects/0/prjs1338/MSMMAEEmbeddingsNatHear
score_dir=nathear_scores
task_name=${task_names[$SLURM_ARRAY_TASK_ID]}
task_dir=${task_dirs[$SLURM_ARRAY_TASK_ID]}

model_name=hear_configs.msm_mae
model_size=base
