...
from .feature_helper import LogMelSpec
from hear21passt.models.passt import get_model as get_model_passt

class RuntimePASST(nn.Module):
    def __init__(self,  max_model_window=10000, timestamp_window=160, timestamp_hop=50,
        ...
        self.net = get_model_passt(arch=kwargs.get("arch", "passt_s_swa_p16_128_ap476"))
    ...
    def get_scene_embeddings(self, audio):
        ...
        try:
            ...
            n_sound, n_samples, n_channels = audio.shape 
